...
*/
void initialize_forest(char forest[D_S][D_S]){
    int row, col;
...
It takes in the 2-D character array of the forest.
*/
int iterate_forest(char forest[D_S][D_S]){
...
It takes in the 2-D character array of the forest.
*/
void printForestCycles(char forest[D_S][D_S]){
...
It takes in the 2-D character array of the forest.
*/
void printForestOverlay(char forest[D_S][D_S]){
    int row, col;
    set_cur_pos(1,0);
    for(row = 0; row < D_S; row++){
        for(col = 0; col < D_S; col++){
